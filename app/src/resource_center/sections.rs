    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                url: "https://example.invalid/swarf/docs/terminal/appearance/prompt",
            ...
            ContentItem {
                ...
                url: "https://example.invalid/swarf/docs/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How Warp uses Warp",
                description: "Learn how Warp's engineering team uses their favorite features",
                url: "https://example.invalid/swarf/blog/how-warp-uses-warp",
