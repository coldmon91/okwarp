        ...
        Align::new(
            appearance
                ...
                .link(
                    ...
                    Some(
                        "https://example.invalid/swarf/docs/terminal/appearance/custom-themes"
                            .to_string(),
                    ),
                    None,
    ...
    fn render(
        ...
        let label_info = AdditionalInfo {
            ...
            on_click_action: Some(AppearancePageAction::OpenUrl(
                "https://example.invalid/swarf/docs/terminal/appearance/size-opacity-blurring"
                    .into(),
            )),
            secondary_text: None,
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            ...
            Some(AdditionalInfo {
                ...
                on_click_action: Some(AppearancePageAction::OpenUrl(
                    "https://example.invalid/swarf/docs/terminal/more-features/full-screen-apps#padding".into(),
                )),
                secondary_text: None,
                tooltip_override_text: None,
            }),
