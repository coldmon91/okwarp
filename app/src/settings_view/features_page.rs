        ...
        let labeled_switch = render_body_item::<FeaturesPageAction>(
            ...
            Some(AdditionalInfo {
                ...
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                    "https://example.invalid/swarf/docs/terminal/sessions/session-restoration"
                        .into(),
                )),
                secondary_text: None,
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            ...
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                    "https://example.invalid/swarf/docs/terminal/blocks/sticky-command-header"
                        .into(),
                )),
                secondary_text: None,
                tooltip_override_text: None,
                    ...
                    .with_children([
                        ...
                        ui_builder
                            .link(
                                "See docs.".to_owned(),
                                Some(
                                    "https://example.invalid/swarf/docs/terminal/windows/global-hotkey"
                                        .to_owned(),
                                ),
                                None,
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            ...
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                    "https://example.invalid/swarf/docs/terminal/more-features/full-screen-apps#mouse-and-scroll-reporting"
                        .into(),
                )),
                secondary_text: None,
                tooltip_override_text: None,
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            ...
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                    "https://example.invalid/swarf/docs/terminal/more-features/text-selection"
                        .into(),
                )),
                secondary_text: None,
                tooltip_override_text: None,
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            ...
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                    "https://example.invalid/swarf/docs/terminal/entry/yaml-workflows".into(),
                )),
                secondary_text: None,
                tooltip_override_text: None,
            }),
