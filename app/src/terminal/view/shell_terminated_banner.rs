                    ...
                    ui_builder
                        ...
                        .on_click(|ctx, _, _| {
                            ctx.dispatch_typed_action(Action::OpenUrl(
                                "https://example.invalid/swarf/issues/new/choose".to_string(),
                            ));
                        })
                        .finish(),
                    ui_builder
                        ...
                        .on_click(|ctx, _, _| {
                            ctx.dispatch_typed_action(Action::OpenUrl(
                                "https://example.invalid/swarf/docs/support-and-community/troubleshooting-and-support/known-issues#debugging".to_string(),
                            ));
                        })
                        .finish(),
                ]
