...
pub const SSH_DOCS_URL: &str = "https://example.invalid/swarf/docs/terminal/warpify/ssh";
pub const SUBSHELL_DOCS_URL: &str = "https://example.invalid/swarf/docs/terminal/warpify/subshells";
